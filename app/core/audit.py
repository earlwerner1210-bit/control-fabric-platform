...
class FabricAuditEventType(str, enum.Enum):
    ...
    RECONCILIATION_RUN_STARTED = "fabric.reconciliation.run_started"
    RECONCILIATION_RUN_COMPLETED = "fabric.reconciliation.run_completed"
    RECONCILIATION_CANDIDATE_GENERATED = "fabric.reconciliation.candidate_generated"
    RECONCILIATION_CASE_CREATED = "fabric.reconciliation.case_created"
    RECONCILIATION_CASE_CLASSIFIED = "fabric.reconciliation.case_classified"
    RECONCILIATION_DUPLICATE_DETECTED = "fabric.reconciliation.duplicate_detected"
    RECONCILIATION_COVERAGE_GAP_DETECTED = "fabric.reconciliation.coverage_gap_detected"
    RECONCILIATION_INSUFFICIENT_EVIDENCE = "fabric.reconciliation.insufficient_evidence"
    RECONCILIATION_OUTCOME_HASHED = "fabric.reconciliation.outcome_hashed"
    VALIDATION_RUN_STARTED = "fabric.validation.run_started"
    VALIDATION_RUN_COMPLETED = "fabric.validation.run_completed"
    VALIDATION_STEP_COMPLETED = "fabric.validation.step_completed"
    VALIDATION_FAILED = "fabric.validation.failed"
    VALIDATION_DECISION_RECORDED = "fabric.validation.decision_recorded"
    VALIDATION_REPORT_HASHED = "fabric.validation.report_hashed"
    ACTION_PROPOSED = "fabric.action.proposed"
    ACTION_APPROVED = "fabric.action.approved"
    ACTION_REJECTED = "fabric.action.rejected"
    ACTION_RELEASED = "fabric.action.released"
    ACTION_EVIDENCE_MANIFEST_CREATED = "fabric.action.evidence_manifest_created"
    ACTION_POLICY_BLOCKED = "fabric.action.policy_blocked"
    ACTION_DECISION_HASHED = "fabric.action.decision_hashed"
