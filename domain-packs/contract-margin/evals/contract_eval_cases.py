...
CONTRACT_EVAL_CASES: list[dict] = [
    {
        ...
        "input": {
            ...
            "contract": {
                ...
                "rate_card": [
                    {"role_or_item": "Senior Network Engineer", "rate": 150.0, "currency": "USD", "rate_unit": "hourly"},
                ],
                "clauses": [
                    {"clause_type": "scope", "text": "In scope: network configuration, testing, and deployment activities."},
                ],
                "billable_events": [],
                "sla_entries": [],
            },
    ...
    },
    {
        ...
        "input": {
            ...
            "contract": {
                ...
                "rate_card": [
                    {"role_or_item": "Senior Network Engineer", "rate": 150.0, "currency": "USD", "rate_unit": "hourly"},
                    {"role_or_item": "Project Manager", "rate": 120.0, "currency": "USD", "rate_unit": "hourly"},
                ],
                "clauses": [],
                "billable_events": [],
                "sla_entries": [],
    ...
    },
    {
        ...
        "input": {
            "contract": {
                ...
                "billing_category": "time_and_materials",
                "rate_card": [
                    {"role_or_item": "Field Engineer", "rate": 100.0, "currency": "USD", "rate_unit": "hourly"},
                ],
                "penalties": [],
            },
            "work_history": [
                {"entry_id": "WH-001", "description": "Site survey", "role": "Field Engineer", "hours": 6.0, "actual_rate": 100.0, "date": "2025-01-15", "billed": False, "in_original_scope": True},
                {"entry_id": "WH-002", "description": "Equipment install", "role": "Field Engineer", "hours": 8.0, "actual_rate": 100.0, "date": "2025-01-16", "billed": True, "in_original_scope": True},
                {"entry_id": "WH-003", "description": "Post-install testing", "role": "Field Engineer", "hours": 4.0, "actual_rate": 100.0, "date": "2025-01-17", "billed": False, "in_original_scope": True},
            ],
        },
        "expected_output": {
