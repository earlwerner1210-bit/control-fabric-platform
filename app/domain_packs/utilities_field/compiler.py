    ...
    "confined_space": [
        {
            ...
            "description": "Confined space risk assessment completed and signed",
            "category": "confined_space",
        },
        {
            "precondition_type": "method_statement",
            "description": "Confined space method statement approved",
            "category": "confined_space",
        },
        {
            "precondition_type": "ppe",
            "description": "Gas monitor and rescue harness required",
            "category": "confined_space",
        },
        {
            "precondition_type": "toolbox_talk",
            "description": "Confined space toolbox talk delivered",
            "category": "confined_space",
        },
        {
            "precondition_type": "certification",
            "description": "Confined space entry certification valid",
            "category": "confined_space",
        },
    ],
    "hot_works": [
        {
            "precondition_type": "risk_assessment",
            "description": "Hot works fire risk assessment completed",
            "category": "hot_works",
        },
        {
            "precondition_type": "ppe",
            "description": "Fire-resistant PPE and fire extinguisher on site",
            "category": "hot_works",
        },
        {
            "precondition_type": "certification",
            "description": "Hot works certification valid",
            "category": "hot_works",
        },
    ],
    "height_works": [
        {
            "precondition_type": "risk_assessment",
            "description": "Working at height risk assessment completed",
            "category": "height_works",
        },
        {
            "precondition_type": "ppe",
            "description": "Full body harness and lanyard required",
            "category": "height_works",
        },
        {
            "precondition_type": "method_statement",
            "description": "Working at height method statement approved",
            "category": "height_works",
        },
        {
            "precondition_type": "certification",
            "description": "Working at height certification valid",
            "category": "height_works",
        },
    ],
    "street_works": [
        {
            "precondition_type": "risk_assessment",
            "description": "Traffic management risk assessment completed",
            "category": "street_works",
        },
        {
            "precondition_type": "ppe",
            "description": "High-visibility clothing and traffic cones",
            "category": "street_works",
        },
    ],
}
...
class FieldCompiler:
    ...
    def compile_dispatch_preconditions(
                ...
                preconds.append(
                    {
                        ...
                        "resolution": ""
                        if met
                        else f"Obtain {req.permit_type.value} permit before dispatch",
                    }
                )
        ...
        preconds.append(
            {
                ...
                else "Confirm customer availability before dispatch",
            }
        )
        ...
        unavailable_materials = [
            m for m in work_order.materials_required if not m.get("available", True)
        ]
        ...
        preconds.append(
            {
                ...
                "resolution": ""
                if materials_met
                else f"{len(unavailable_materials)} material(s) unavailable",
            }
        )
        ...
        if work_order.weather_conditions:
            ...
            if any(
                w in weather_lower
                for w in ("storm", "severe", "hurricane", "tornado", "blizzard", "flooding")
            ):
                weather_ok = False
        preconds.append(
            {
                ...
                "resolution": ""
                if weather_ok
                else f"Unsafe weather: {work_order.weather_conditions}",
            }
        )
    ...
    def compile_readiness_checks(
        ...
        checks.append(
            {
                ...
                "detail": f"Missing skills: {', '.join(sorted(missing))}"
                if missing
        ...
        checks.append(
            {
                ...
                "detail": f"Missing permits: {', '.join(missing_permits)}"
                if missing_permits
                else "All permits obtained",
        ...
        checks.append(
            {
                ...
                "detail": f"Expired: {', '.join(expired_accreds)}"
                if expired_accreds
                else "All accreditations valid",
        ...
        checks.append(
            {
                ...
                "detail": "Customer confirmed"
                if work_order.customer_confirmed
                else "Customer not yet confirmed",
        ...
        if work_order.weather_conditions:
            ...
            if any(
                w in wc for w in ("storm", "severe", "hurricane", "tornado", "blizzard", "flooding")
            ):
                weather_ok = False
        ...
        checks.append(
            {
                ...
                "detail": f"{len(incomplete_deps)} blocking dependency/ies incomplete"
                if incomplete_deps
    ...
    def compile_field_leakage_triggers(
        ...
        # Skill gap leakage
        skill_gap_count = sum(1 for h in field_history if h.get("exception_type") == "skill_gap")
